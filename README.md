...
# License
The [Functional Source License (FSL)](https://fsl.software/) is a Fair Source license that converts to Apache 2.0 or MIT after two years. In other words, you may use Marco in your software so long as it does not compete with our paid products.

# Funding
Marco is available under the [Functional Source License (FSL)](https://fsl.software/). If you find Marco useful, please consider supporting its development by purchasing a license or making a donation.
